...
def plot_points(raw_img,valid_peak_list,class_names):
	...
	for p in peaks:
		plt.scatter([p[3]], [p[2]], s=75, c=class2color[p[1]],label='{}'.format(class_names[p[1]]))
...
if __name__ == '__main__':
	...
	aggregation, class_response_maps, valid_peak_list, peak_response_maps = model(input_var)
